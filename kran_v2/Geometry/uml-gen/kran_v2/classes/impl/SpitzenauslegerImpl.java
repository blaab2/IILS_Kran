...
public class SpitzenauslegerImpl extends InstanceWrapperImpl implements kran_v2.classes.Spitzenausleger {
	 ...
	 */
	public SpitzenauslegerImpl(String name) {
	 ...
	 */
	public SpitzenauslegerImpl(org.eclipse.uml2.uml.InstanceSpecification inst) {
		umlInstance = inst;
	...
	private void loadPropRefs() {
		for (org.eclipse.uml2.uml.Property p : umlClass.getAllAttributes()) {
			if (p.getName().equals("nextspitzenausleger")) {
				_umlPropNextspitzenausleger = p;
				continue;
			}
			if (p.getName().equals("spitzenauslegeradapter1")) {
				_umlPropSpitzenauslegeradapter1 = p;
				continue;
			}
			if (p.getName().equals("prevtheta")) {
				_umlPropPrevtheta = p;
				continue;
			}
			if (p.getName().equals("spitzenauslegeradapter2")) {
				_umlPropSpitzenauslegeradapter2 = p;
				continue;
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropNextspitzenausleger;
	public org.eclipse.uml2.uml.Property umlPropNextspitzenausleger() {
		if (_umlPropNextspitzenausleger == null) {
			loadPropRefs();
		}
		return _umlPropNextspitzenausleger;
	}
	public org.eclipse.uml2.uml.Slot umlSlotNextspitzenausleger() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropNextspitzenausleger()) {
				return s;
			}
		}
		return null;
	...
	public Spitzenausleger getNextspitzenausleger() {
		org.eclipse.uml2.uml.InstanceSpecification targetInst = getInstanceByProperty(umlInstance(), umlPropNextspitzenausleger().getName());
		if (targetInst != null) {
	...
	public void setNextspitzenausleger(Spitzenausleger nextspitzenausleger) {
		if (getNextspitzenausleger() != null) {
			deleteUniLinks(umlInstance, umlPropNextspitzenausleger());
		}
		if (nextspitzenausleger != null) {
			createUniLink(umlInstance, umlPropNextspitzenausleger().getName(), nextspitzenausleger.umlInstance());
		}
	}
	public Spitzenausleger nextspitzenausleger_(Spitzenausleger nextspitzenausleger) {
		setNextspitzenausleger(nextspitzenausleger);
		return this;
	}
	private org.eclipse.uml2.uml.Property _umlPropSpitzenauslegeradapter1;
	public org.eclipse.uml2.uml.Property umlPropSpitzenauslegeradapter1() {
		if (_umlPropSpitzenauslegeradapter1 == null) {
			loadPropRefs();
		}
		return _umlPropSpitzenauslegeradapter1;
	}
	public org.eclipse.uml2.uml.Slot umlSlotSpitzenauslegeradapter1() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropSpitzenauslegeradapter1()) {
				return s;
			}
		}
		return null;
	...
	public Spitzenauslegeradapter getSpitzenauslegeradapter1() {
		org.eclipse.uml2.uml.InstanceSpecification targetInst = getInstanceByProperty(umlInstance(), umlPropSpitzenauslegeradapter1().getName());
		if (targetInst != null) {
			return UML2JavaMap.<Spitzenauslegeradapter>findOrCreateWrapper(targetInst);
		}
		return null;
	}
	public void setSpitzenauslegeradapter1(Spitzenauslegeradapter spitzenauslegeradapter1) {
		if (getSpitzenauslegeradapter1() != null) {
			deleteUniLinks(umlInstance, umlPropSpitzenauslegeradapter1());
		}
		if (spitzenauslegeradapter1 != null) {
			createUniLink(umlInstance, umlPropSpitzenauslegeradapter1().getName(), spitzenauslegeradapter1.umlInstance());
		}
	}
	public Spitzenausleger spitzenauslegeradapter1_(Spitzenauslegeradapter spitzenauslegeradapter1) {
		setSpitzenauslegeradapter1(spitzenauslegeradapter1);
		return this;
	}
	private org.eclipse.uml2.uml.Property _umlPropPrevtheta;
	public org.eclipse.uml2.uml.Property umlPropPrevtheta() {
		if (_umlPropPrevtheta == null) {
			loadPropRefs();
		}
		return _umlPropPrevtheta;
	}
	public org.eclipse.uml2.uml.Slot umlSlotPrevtheta() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropPrevtheta()) {
				return s;
			}
		}
		return null;
	...
	public Double getPrevtheta() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropPrevtheta().getName());
	}
	public void setPrevtheta(Double prevtheta) {
		setSlotValueByProperty(umlInstance(), umlPropPrevtheta().getName(), prevtheta.toString());
	}
	public Spitzenausleger prevtheta_(Double prevtheta, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setPrevtheta(prevtheta);
		org.eclipse.uml2.uml.Slot slot = umlSlotPrevtheta();
	...
	private org.eclipse.uml2.uml.Property _umlPropSpitzenauslegeradapter2;
	public org.eclipse.uml2.uml.Property umlPropSpitzenauslegeradapter2() {
		if (_umlPropSpitzenauslegeradapter2 == null) {
			loadPropRefs();
		}
		return _umlPropSpitzenauslegeradapter2;
	}
	public org.eclipse.uml2.uml.Slot umlSlotSpitzenauslegeradapter2() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropSpitzenauslegeradapter2()) {
				return s;
			}
		}
		return null;
	...
	public Spitzenauslegeradapter getSpitzenauslegeradapter2() {
		org.eclipse.uml2.uml.InstanceSpecification targetInst = getInstanceByProperty(umlInstance(), umlPropSpitzenauslegeradapter2().getName());
		if (targetInst != null) {
			return UML2JavaMap.<Spitzenauslegeradapter>findOrCreateWrapper(targetInst);
		}
		return null;
	...
	public void setSpitzenauslegeradapter2(Spitzenauslegeradapter spitzenauslegeradapter2) {
		if (getSpitzenauslegeradapter2() != null) {
			deleteUniLinks(umlInstance, umlPropSpitzenauslegeradapter2());
		}
		if (spitzenauslegeradapter2 != null) {
			createUniLink(umlInstance, umlPropSpitzenauslegeradapter2().getName(), spitzenauslegeradapter2.umlInstance());
		}
	}
	public Spitzenausleger spitzenauslegeradapter2_(Spitzenauslegeradapter spitzenauslegeradapter2) {
		setSpitzenauslegeradapter2(spitzenauslegeradapter2);
		return this;
	}
