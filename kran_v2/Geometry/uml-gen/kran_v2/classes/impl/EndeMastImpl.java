...
public class EndeMastImpl extends InstanceWrapperImpl implements kran_v2.classes.EndeMast {
	 ...
	 */
	public EndeMastImpl(String name) {
	 ...
	 */
	public EndeMastImpl(org.eclipse.uml2.uml.InstanceSpecification inst) {
		umlInstance = inst;
	...
	private void loadPropRefs() {
		for (org.eclipse.uml2.uml.Property p : umlClass.getAllAttributes()) {
			if (p.getName().equals("endstueckx1")) {
				_umlPropEndstueckx1 = p;
				continue;
			}
			if (p.getName().equals("endstuecky1")) {
				_umlPropEndstuecky1 = p;
				continue;
			}
			if (p.getName().equals("endstueckz1")) {
				_umlPropEndstueckz1 = p;
				continue;
			}
			if (p.getName().equals("endstueckx2")) {
				_umlPropEndstueckx2 = p;
				continue;
			}
			if (p.getName().equals("endstuecky2")) {
				_umlPropEndstuecky2 = p;
				continue;
			}
			if (p.getName().equals("endstueckz2")) {
				_umlPropEndstueckz2 = p;
				continue;
			}
			if (p.getName().equals("auslegerEnde")) {
				_umlPropAuslegerEnde = p;
				continue;
			}
	...
	public Double getEndstueckx1() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstueckx1().getName());
	}
	public void setEndstueckx1(Double endstueckx1) {
		setSlotValueByProperty(umlInstance(), umlPropEndstueckx1().getName(), endstueckx1.toString());
	}
	public EndeMast endstueckx1_(Double endstueckx1, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstueckx1(endstueckx1);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstueckx1();
	...
	private org.eclipse.uml2.uml.Property _umlPropEndstuecky1;
	public org.eclipse.uml2.uml.Property umlPropEndstuecky1() {
		if (_umlPropEndstuecky1 == null) {
			loadPropRefs();
		}
		return _umlPropEndstuecky1;
	}
	public org.eclipse.uml2.uml.Slot umlSlotEndstuecky1() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropEndstuecky1()) {
				return s;
			}
		}
		return null;
	...
	public Double getEndstuecky1() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstuecky1().getName());
	}
	public void setEndstuecky1(Double endstuecky1) {
		setSlotValueByProperty(umlInstance(), umlPropEndstuecky1().getName(), endstuecky1.toString());
	}
	public EndeMast endstuecky1_(Double endstuecky1, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstuecky1(endstuecky1);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstuecky1();
		for (org.eclipse.uml2.uml.Stereotype stereo : slotStereos) {
			if (!slot.isStereotypeApplied(stereo)) {
				slot.applyStereotype(stereo);
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropEndstueckz1;
	public org.eclipse.uml2.uml.Property umlPropEndstueckz1() {
		if (_umlPropEndstueckz1 == null) {
			loadPropRefs();
		}
		return _umlPropEndstueckz1;
	}
	public org.eclipse.uml2.uml.Slot umlSlotEndstueckz1() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropEndstueckz1()) {
				return s;
			}
		}
		return null;
	...
	public Double getEndstueckz1() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstueckz1().getName());
	}
	public void setEndstueckz1(Double endstueckz1) {
		setSlotValueByProperty(umlInstance(), umlPropEndstueckz1().getName(), endstueckz1.toString());
	}
	public EndeMast endstueckz1_(Double endstueckz1, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstueckz1(endstueckz1);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstueckz1();
		for (org.eclipse.uml2.uml.Stereotype stereo : slotStereos) {
			if (!slot.isStereotypeApplied(stereo)) {
				slot.applyStereotype(stereo);
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropEndstueckx2;
	public org.eclipse.uml2.uml.Property umlPropEndstueckx2() {
		if (_umlPropEndstueckx2 == null) {
			loadPropRefs();
		}
		return _umlPropEndstueckx2;
	}
	public org.eclipse.uml2.uml.Slot umlSlotEndstueckx2() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropEndstueckx2()) {
				return s;
			}
		}
		return null;
	...
	public Double getEndstueckx2() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstueckx2().getName());
	}
	public void setEndstueckx2(Double endstueckx2) {
		setSlotValueByProperty(umlInstance(), umlPropEndstueckx2().getName(), endstueckx2.toString());
	}
	public EndeMast endstueckx2_(Double endstueckx2, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstueckx2(endstueckx2);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstueckx2();
		for (org.eclipse.uml2.uml.Stereotype stereo : slotStereos) {
			if (!slot.isStereotypeApplied(stereo)) {
				slot.applyStereotype(stereo);
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropEndstuecky2;
	public org.eclipse.uml2.uml.Property umlPropEndstuecky2() {
		if (_umlPropEndstuecky2 == null) {
			loadPropRefs();
		}
		return _umlPropEndstuecky2;
	}
	public org.eclipse.uml2.uml.Slot umlSlotEndstuecky2() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropEndstuecky2()) {
				return s;
			}
		}
		return null;
	...
	public Double getEndstuecky2() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstuecky2().getName());
	}
	public void setEndstuecky2(Double endstuecky2) {
		setSlotValueByProperty(umlInstance(), umlPropEndstuecky2().getName(), endstuecky2.toString());
	}
	public EndeMast endstuecky2_(Double endstuecky2, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstuecky2(endstuecky2);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstuecky2();
		for (org.eclipse.uml2.uml.Stereotype stereo : slotStereos) {
			if (!slot.isStereotypeApplied(stereo)) {
				slot.applyStereotype(stereo);
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropEndstueckz2;
	public org.eclipse.uml2.uml.Property umlPropEndstueckz2() {
		if (_umlPropEndstueckz2 == null) {
			loadPropRefs();
		}
		return _umlPropEndstueckz2;
	}
	public org.eclipse.uml2.uml.Slot umlSlotEndstueckz2() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropEndstueckz2()) {
				return s;
			}
		}
		return null;
	...
	public Double getEndstueckz2() {
		return getSlotDoubleValueByProperty(umlInstance(), umlPropEndstueckz2().getName());
	}
	public void setEndstueckz2(Double endstueckz2) {
		setSlotValueByProperty(umlInstance(), umlPropEndstueckz2().getName(), endstueckz2.toString());
	}
	public EndeMast endstueckz2_(Double endstueckz2, org.eclipse.uml2.uml.Stereotype... slotStereos) {
		setEndstueckz2(endstueckz2);
		org.eclipse.uml2.uml.Slot slot = umlSlotEndstueckz2();
		for (org.eclipse.uml2.uml.Stereotype stereo : slotStereos) {
			if (!slot.isStereotypeApplied(stereo)) {
				slot.applyStereotype(stereo);
			}
	...
	private org.eclipse.uml2.uml.Property _umlPropAuslegerEnde;
	public org.eclipse.uml2.uml.Property umlPropAuslegerEnde() {
		if (_umlPropAuslegerEnde == null) {
			loadPropRefs();
		}
		return _umlPropAuslegerEnde;
	}
	public org.eclipse.uml2.uml.Slot umlSlotAuslegerEnde() {
		for (org.eclipse.uml2.uml.Slot s : umlInstance.getSlots()) {
			if (s.getDefiningFeature() == umlPropAuslegerEnde()) {
				return s;
			}
		}
		return null;
	...
	public auslegerende.classes.AuslegerEnde getAuslegerEnde() {
		org.eclipse.uml2.uml.InstanceSpecification targetInst = getInstanceByProperty(umlInstance(), umlPropAuslegerEnde().getName());
		if (targetInst != null) {
			return UML2JavaMap.<auslegerende.classes.AuslegerEnde>findOrCreateWrapper(targetInst);
		}
		return null;
	}
	public void setAuslegerEnde(auslegerende.classes.AuslegerEnde auslegerEnde) {
		if (getAuslegerEnde() != null) {
			deleteUniLinks(umlInstance, umlPropAuslegerEnde());
		}
		if (auslegerEnde != null) {
			createUniLink(umlInstance, umlPropAuslegerEnde().getName(), auslegerEnde.umlInstance());
		}
	}
	public EndeMast auslegerEnde_(auslegerende.classes.AuslegerEnde auslegerEnde) {
		setAuslegerEnde(auslegerEnde);
		return this;
	}
