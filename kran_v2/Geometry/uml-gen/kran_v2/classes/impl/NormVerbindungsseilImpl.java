...
public class NormVerbindungsseilImpl extends InstanceWrapperImpl implements kran_v2.classes.NormVerbindungsseil {
	 ...
	 */
	public NormVerbindungsseilImpl(String name) {
	 ...
	 */
	public NormVerbindungsseilImpl(org.eclipse.uml2.uml.InstanceSpecification inst) {
		umlInstance = inst;
