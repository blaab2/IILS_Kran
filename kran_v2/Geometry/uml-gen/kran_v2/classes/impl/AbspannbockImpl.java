...
public class AbspannbockImpl extends InstanceWrapperImpl implements kran_v2.classes.Abspannbock {
	 ...
	 */
	public AbspannbockImpl(String name) {
	 ...
	 */
	public AbspannbockImpl(org.eclipse.uml2.uml.InstanceSpecification inst) {
		umlInstance = inst;
